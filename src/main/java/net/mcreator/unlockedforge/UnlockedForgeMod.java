package net.mcreator.unlockedforge;
...
@Mod("unlocked_forge")
public class UnlockedForgeMod {
	public static final Logger LOGGER = LogManager.getLogger(UnlockedForgeMod.class);
	public static final String MODID = "unlocked_forge";

	public UnlockedForgeMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		UnlockedForgeModItems.REGISTRY.register(bus);
